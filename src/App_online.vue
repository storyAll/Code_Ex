    ...
    preBim () {
      ...
      let initBIM = () => {
        ...
        if (typeof bimFrame !== 'undefined' && bimFrame.window && typeof bimFrame.window.init !== 'undefined') {
          ...
          var structureUrl = 'Data/jdall2.rvt'
          var protertyUrl = 'Data/jdall2.rvt.Properties'
          var devHost = [
            'localhost',
            '127.0.0.1'
          ]
          if (devHost.indexOf(window.location.host) > -1) {

          } else {
            structureUrl = '/Data/jdall2.rvt'
            protertyUrl = '/Data/jdall2.rvt.Properties'
          }
